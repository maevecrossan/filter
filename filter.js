...
const paul = people.filter(p => p.name === "Paul")[0]; //person shortened to p. [0] accesses object.
...
console.log(names); // to get only names of candidates
...
const topMaths = students1.filter(student => student.results.maths >= 5);
